...
def main_body():
    ...
    parser = argparse.ArgumentParser(prog='DependencyParse_FrequencyPruning', usage='DependencyParse_FrequencyPruning.py <label> <depParse_features> <passage_dict_loc> <outputJSON> <numfeatures>', description='Script to perform frequency analysis of the dependency parse features')
