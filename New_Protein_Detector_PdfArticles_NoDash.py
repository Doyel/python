...
def read_dirs(fst_file, symboltable_file, max_prot_len, PubMedfilelist):
    ...
    rootDir = '/ua/ml-group/big-mechanism-project/PLEIADES/Feb2017/JSON_SENTENCE_ASSOCS'
    writeDir = '/ua/ml-group/big-mechanism-project/PLEIADES/Feb2017/protein_detect_output'
